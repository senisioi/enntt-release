...
- For the experiments in the paper Nisioi, S., Rabinovich, E., Dinu, L. P., and Wintner, S.: **A Corpus of Native, Non-native and Translated Texts** LREC, 2016, [PDF](http://www.lrec-conf.org/proceedings/lrec2016/summaries/902.html) dataset also available [here](http://nlp.unibuc.ro/resources/LREC2016_experiment.tar.gz).
